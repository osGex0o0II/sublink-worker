...
export const translations = {
  'zh-CN': {
    ...
    externalControllerPlaceholder: '默认 127.0.0.1:9090',
    ...
    proxyRoute: '代理',
    rejectRoute: '拦截',
    selectedRulesLabel: '当前规则',
    noOptionalRules: '无额外可选规则',
    rulesUnit: '项规则',
    customPresetHint: '手动勾选',
    custom: '自定义',
    basic: '基础智能',
    smart: '智能推荐',
    smartSummary: '国内直连、广告拦截、BT直连，海外服务代理',
    lite: '精简',
    liteSummary: '只保留直连、广告拦截和海外代理',
    full: '全分组',
    fullSummary: '完整服务分组，适合需要独立策略的用户',
    advancedCategoryRules: '高级分类调整',
  ...
  'en-US': {
    ...
    externalControllerPlaceholder: 'Default 127.0.0.1:9090',
    ...
    mandatoryRules: 'Always Enabled',
    directRoute: 'Direct',
    proxyRoute: 'Proxy',
    rejectRoute: 'Reject',
    selectedRulesLabel: 'Selected Rules',
    noOptionalRules: 'No extra optional rules',
    rulesUnit: 'rules',
    customPresetHint: 'Manual pick',
    custom: 'Custom',
    basic: 'Smart Basic',
    smart: 'Smart Recommended',
    smartSummary: 'Direct for domestic and BT, block ads, proxy overseas services',
    lite: 'Lite',
    liteSummary: 'Keep only direct, ad blocking, and overseas proxying',
    full: 'All Groups',
    fullSummary: 'Complete service groups for independent policies',
    advancedCategoryRules: 'Advanced category rules',
  ...
  'fa': {
    ...
    rulePreset: 'پیش‌فرض قوانین',
    mandatoryRules: 'همیشه فعال',
    directRoute: 'مستقیم',
    proxyRoute: 'پروکسی',
    rejectRoute: 'مسدود',
    selectedRulesLabel: 'قوانین انتخاب‌شده',
    noOptionalRules: 'بدون قانون اختیاری اضافه',
    rulesUnit: 'قانون',
    customPresetHint: 'انتخاب دستی',
    custom: 'سفارشی',
    basic: 'هوشمند پایه',
    smart: 'پیشنهاد هوشمند',
    smartSummary: 'داخلی و BT مستقیم، تبلیغات مسدود، سرویس‌های خارجی پروکسی',
    lite: 'سبک',
    liteSummary: 'فقط مسیر مستقیم، مسدودسازی تبلیغات و پروکسی خارجی',
    full: 'همه گروه‌ها',
    fullSummary: 'گروه‌های کامل سرویس برای سیاست‌های مستقل',
    advancedCategoryRules: 'تنظیم پیشرفته دسته‌ها',
  ...
  'ru': {
    ...
    rulePreset: 'Набор правил',
    mandatoryRules: 'Всегда включено',
    directRoute: 'Прямое',
    proxyRoute: 'Прокси',
    rejectRoute: 'Блок',
    selectedRulesLabel: 'Выбранные правила',
    noOptionalRules: 'Нет дополнительных правил',
    rulesUnit: 'правил',
    customPresetHint: 'Ручной выбор',
    custom: 'Пользовательский',
    basic: 'Базовый умный',
    smart: 'Умная рекомендация',
    smartSummary: 'Прямое подключение для внутренних и BT, блокировка рекламы, прокси для зарубежных сервисов',
    lite: 'Облегчённый',
    liteSummary: 'Только прямое подключение, блокировка рекламы и зарубежный прокси',
    full: 'Все группы',
    fullSummary: 'Полные группы сервисов для независимых политик',
    advancedCategoryRules: 'Расширенные категории',
